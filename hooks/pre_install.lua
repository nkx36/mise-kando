...
function PLUGIN:PreInstall(ctx)
    ...
    -- local url = "https://github.com/nkx36/mise-kando/releases/download/v" .. version .. "/mise-linux-amd64"

    -- Example 2: Platform-specific binary
    -- local platform = get_platform() -- Uncomment the helper function below
    -- local url = "https://github.com/nkx36/mise-kando/releases/download/v" .. version .. "/mise-" .. platform

    -- Example 3: Archive (tar.gz, zip) - mise will extract automatically
    -- local url = "https://github.com/nkx36/mise-kando/releases/download/v" .. version .. "/mise-" .. version .. "-linux-amd64.tar.gz"

    -- Example 4: Raw file from repository
    -- local url = "https://raw.githubusercontent.com/nkx36/mise-kando/" .. version .. "/bin/mise"

    -- Replace with your actual download URL pattern
    local url = "https://example.com/mise/releases/download/" .. version .. "/mise"
